...
#   Usage:
#
#   Run the import script from the root of the Django project via
#   ./manage.py shell
#
...
#
#   Run import_members(), import_contracts(), then import_payments(),
#   in that order.
#
#   After running each method, check in XXX_REJECTS, where 'XXX'
#   is one of MEMBER, CONTRACT or PAYMENT.
#   These arrays contain the objects that failed to be save properly.
#   On the shell, take the time to diagnose the problem and fix if necessary.
#
