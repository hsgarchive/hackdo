...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'hado_payment', 'verified', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'Payment.verified'
        db.alter_column(u'hado_payment', 'verified', self.gf('django.db.models.fields.BooleanField')())
