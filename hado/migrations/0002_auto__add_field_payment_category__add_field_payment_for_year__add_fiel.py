...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('hado_payment', 'for_year', self.gf('django.db.models.fields.IntegerField')(default=2010), keep_default=False)

        # Adding field 'Payment.for_month'
        db.add_column('hado_payment', 'for_month', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Changing field 'Payment.date_paid'
        db.alter_column('hado_payment', 'date_paid', self.gf('django.db.models.fields.DateField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Payment.date_paid'
        db.alter_column('hado_payment', 'date_paid', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True))
    ...
    models = {
        ...
        'hado.payment': {
            ...
            'for_month': ('django.db.models.fields.IntegerField', [], {}),
