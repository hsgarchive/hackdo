...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HackDoUser.is_gravatar_enabled'
        db.add_column(u'hado_hackdouser', 'is_gravatar_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HackDoUser.is_gravatar_enabled'
        db.delete_column(u'hado_hackdouser', 'is_gravatar_enabled')
