...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contract.valid_till'
        db.alter_column('hado_contract', 'valid_till', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):

        # Changing field 'Contract.valid_till'
        db.alter_column('hado_contract', 'valid_till', self.gf('django.db.models.fields.DateField')(null=True))
