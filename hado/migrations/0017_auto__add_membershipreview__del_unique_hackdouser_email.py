...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'HackDoUser', fields ['email']
        db.delete_unique(u'hado_hackdouser', ['email'])

        # Adding model 'MembershipReview'
        db.create_table(u'hado_membershipreview', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('applicant', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'applicant', to=orm['hado.HackDoUser'])),
            ('referrer', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'referrer', to=orm['hado.HackDoUser'])),
            ('reviewed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'hado', ['MembershipReview'])


    def backwards(self, orm):
        # Deleting model 'MembershipReview'
        db.delete_table(u'hado_membershipreview')

        # Adding unique constraint on 'HackDoUser', fields ['email']
        db.create_unique(u'hado_hackdouser', ['email'])
