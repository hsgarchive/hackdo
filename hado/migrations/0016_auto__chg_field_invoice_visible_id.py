...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.visible_id'
        db.alter_column('hado_invoice', 'visible_id', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Invoice.visible_id'
        db.alter_column('hado_invoice', 'visible_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255, unique=True))
    ...
    models = {
        ...
        'hado.invoice': {
            ...
            'visible_id': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'unique': 'True', 'null': 'True'})
        },
        'hado.invoiceitem': {
